...
import com.example.mobileprogrammingproject.databinding.FragmentCovidInfo5Binding;

public class CovidInfo5Fragment extends Fragment {

    private View view;
    private FragmentCovidInfo5Binding mBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) { // fragment는 onCreateView로 생성하면 된다.
        ...
        // set Binding
        mBinding = FragmentCovidInfo5Binding.inflate(getLayoutInflater());
    ...
    public static CovidInfo5Fragment newInstance() {
        return new CovidInfo5Fragment();
    }
