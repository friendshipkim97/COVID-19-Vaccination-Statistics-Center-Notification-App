...
import com.example.mobileprogrammingproject.databinding.FragmentCovidInfo4Binding;

public class CovidInfo4Fragment extends Fragment {

    private View view;
    private FragmentCovidInfo4Binding mBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) { // fragment는 onCreateView로 생성하면 된다.
        ...
        // set Binding
        mBinding = FragmentCovidInfo4Binding.inflate(getLayoutInflater());
    ...
    public static CovidInfo4Fragment newInstance() {
        return new CovidInfo4Fragment();
    }
