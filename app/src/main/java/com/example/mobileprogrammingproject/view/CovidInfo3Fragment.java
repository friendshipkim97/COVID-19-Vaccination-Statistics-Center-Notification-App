...
import com.example.mobileprogrammingproject.databinding.FragmentCovidInfo3Binding;

public class CovidInfo3Fragment extends Fragment {

    private View view;
    private FragmentCovidInfo3Binding mBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) { // fragment는 onCreateView로 생성하면 된다.
        ...
        // set Binding
        mBinding = FragmentCovidInfo3Binding.inflate(getLayoutInflater());
    ...
    public static CovidInfo3Fragment newInstance() {
        return new CovidInfo3Fragment();
    }
