...
import com.example.mobileprogrammingproject.databinding.FragmentCovidInfo2Binding;

public class CovidInfo2Fragment extends Fragment {

    private View view;
    private FragmentCovidInfo2Binding mBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) { // fragment는 onCreateView로 생성하면 된다.
        ...
        // set Binding
        mBinding = FragmentCovidInfo2Binding.inflate(getLayoutInflater());
    ...
    public static CovidInfo2Fragment newInstance() {
        return new CovidInfo2Fragment();
    }
